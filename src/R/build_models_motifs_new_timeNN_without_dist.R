...
for (comb in names(feature_combinations)){
    ...
    ggsave(filename = paste0("results/calderon/motifs/without_dist/mlr3_models_benchmark_omitted_other_species_NN_9windows_different_time_",comb,"_without_dist.pdf"), plot = p, width = 10, height = 20, dpi = 300)
    }
# module with concatenated predicted vectors among time windows
# one model per tissue
#saveRDS(results_to_compare, paste0(getwd(),'/results/calderon/motifs/without_dist/results_to_compare_omitted_other_species_NN_9windows_without_dist.rds'))
results_to_compare = readRDS(paste0(getwd(),'/results/calderon/motifs/without_dist/results_to_compare_omitted_other_species_NN_9windows_without_dist.rds'))
...
ggsave(filename = paste0("results/calderon/motifs/without_dist/plotted_results_to_compare_omitted_other_species_NN_9windows_without_dist.pdf"), plot = p, width = 15, height = 10, dpi = 300)
...
for (comb in names(feature_combinations)){
    ...
    ggsave(filename = paste0("results/calderon/motifs/without_dist/mlr3_models_benchmark_omitted_other_species_NN_9windows_different_time_",comb,"_without_dist_per_tissue.pdf"), plot = p, width = 15, height = 10, dpi = 300)
}
library(ggplot2)
saveRDS(results_to_compare_per_tissue, paste0(getwd(),'/results/calderon/motifs/without_dist/results_to_compare_per_tissue_omitted_other_species_NN_9windows_without_dist.rds'))
results_to_compare_per_tissue_x = readRDS(paste0(getwd(),'/results/calderon/motifs/without_dist/results_to_compare_per_tissue_omitted_other_species_NN_9windows_without_dist.rds'))
# plot results comparison as bar plot
...
ggsave(filename = paste0("results/calderon/motifs/without_dist/plotted_results_to_compare_per_tissue_omitted_other_species_NN_9windows_without_dist.pdf"), plot = p, width = 10, height = 10, dpi = 300)
...
saveRDS(data_df, paste0(getwd(),'/results/calderon/motifs/without_dist/boruta_results_omitted_other_species_NN_features4.rds'))
data_df = readRDS(paste0(getwd(),'/results/calderon/motifs/without_dist/boruta_results_omitted_other_species_NN_features4.rds'))
...
pdf("results/calderon/motifs/without_dist/boruta_heatmap_omitted_other_species_NN_features4.pdf", width = 35, height = 10) 
